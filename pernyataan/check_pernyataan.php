        ...
        <form method="post">
            <div class="form-group">
                ...
                <table id="tabel-data" class="display responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        <?php $query = mysqli_query($conn, "SELECT * FROM pernyataan_dokumen JOIN pernyataan_kegiatan ON pernyataan_dokumen.id_pernyataan_kegiatan = pernyataan_kegiatan.id_pernyataan_kegiatan WHERE status = '2'");
                        $cnt = 1;
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo htmlentities($row['nama_penandatangan']); ?></td>
                                <td><?= "<img src='pernyataan_qr/" . $row['qr_code'] . "'style='width:150px; height:150px;'>" ?></td>
                                <td>
                                    <a href="verify_pernyataan.php?id=<?php echo htmlentities($row['id_pernyataan_kegiatan']); ?>"><button type="button" class="btn btn-primary">Verify</button></a>
                                </td>
