...
$pdf->Cell(15, 5, '', 0, 0);
$pdf->Cell(10, 5, 'Keterangan', 0, 0);
$pdf->Cell(102, 5, ":" . $row['keterangan'], 0, 'L', 0, 0); //end of line
$pdf->Cell(110, 1, '', 0, 1);
...
$pdf->Cell(34, 5, ":" . $row['nama_penandatangan'], 0, 'L', 0, 0); //end of line
...
$pdf->Cell(34, 5, ":" . $row['jabatan_penandatangan'], 0, 'L', 0, 0); //end of line
...
$pdf->SetFont('Times', '', 15);
$pdf->Cell(15, 8, '', 0, 0);
$pdf->Cell(31, 5, 'Nama', 0, 0);
$pdf->Cell(34, 5, ":" . $row['nama'], 0, 'L', 0, 0); //end of line
$pdf->Cell(8, 7, '', 0, 1);

$pdf->SetFont('Times', '', 15);
$pdf->Cell(15, 8, '', 0, 0);
$pdf->Cell(28, 5, 'NPM', 0, 0);
$pdf->Cell(34, 5, ":" . $row['npm'], 0, 'L', 0, 0); //end of line
$pdf->Cell(8, 6, '', 0, 1);

$pdf->SetFont('Times', '', 15);
$pdf->Cell(15, 8, '', 0, 0);
$pdf->Cell(25, 5, 'Jenis Kelamin', 0, 0);
$pdf->Cell(34, 5, ":" . $row['jenis_kelamin'], 0, 'L', 0, 0); //end of line
$pdf->Cell(8, 6, '', 0, 1);

$pdf->SetFont('Times', '', 15);
$pdf->Cell(15, 8, '', 0, 0);
$pdf->Cell(32, 5, 'Alamat', 0, 0);
$pdf->MultiCell(0, 5, ":" . $row['alamat'], 0, 'L', 0, 0); //end of line
$pdf->Cell(8, 4, '', 0, 1);
...
$pdf->Image($fullPath1, 40, 215, 40, 40);
...
$fullPath = $path . $image;
// var_dump($fullPath);
$pdf->Image($fullPath, 90, 215, 80, 0, 'PNG');
