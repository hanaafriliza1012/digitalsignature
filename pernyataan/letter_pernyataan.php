        ...
        <form method="post">
            <div class="form-group">
                ...
                <table id="tabel-data" class="display responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        <?php $query = mysqli_query($conn, "SELECT * FROM pernyataan_kegiatan_peserta JOIN pernyataan_kegiatan ON pernyataan_kegiatan_peserta.id_pernyataan_kegiatan = pernyataan_kegiatan.id_pernyataan_kegiatan JOIN pernyataan_peserta ON pernyataan_kegiatan_peserta.id_pernyataan_peserta = pernyataan_peserta.id_pernyataan_peserta JOIN pernyataan_dokumen ON pernyataan_kegiatan.id_pernyataan_kegiatan = pernyataan_dokumen.id_pernyataan_kegiatan");
                        $cnt = 1;
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo htmlentities($row['jabatan_penandatangan']); ?></td>
                                <td><?= "<img src='pernyataan_qr/" . $row['qr_code'] . "'style='width:150px; height:150px;'>" ?></td>
                                <td>
                                    <!-- <a href="detail.php?id=<?php echo htmlentities($row['id_pernyataan_kegiatan_peserta']); ?>"><button type="button" class="btn btn-primary">Detail</button></a> -->
                                    <a href="print_pernyataan.php?id=<?php echo htmlentities($row['id_pernyataan_kegiatan_peserta']); ?>"><button type="button" class="btn btn-primary">Print</button></a>
                                </td>
