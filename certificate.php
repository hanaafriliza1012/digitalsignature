        ...
        <form method="post">
            <div class="form-group">
                ...
                <table id="tabel-data" class="display responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        <?php $query = mysqli_query($conn, "SELECT * FROM kegiatan_peserta JOIN kegiatan ON kegiatan_peserta.id_kegiatan = kegiatan.id_kegiatan JOIN peserta ON kegiatan_peserta.id_peserta = peserta.id_peserta JOIN dokumen ON kegiatan.id_kegiatan = dokumen.id_kegiatan");
                        $cnt = 1;
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <!-- <a href="detail.php?id=<?php echo htmlentities($row['id_kegiatan_peserta']); ?>"><button type="button" class="btn btn-primary">Detail</button></a> -->
                                    <a href="print.php?id=<?php echo htmlentities($row['id_kegiatan_peserta']); ?>"><button type="button" class="btn btn-primary">Print</button></a>
                                </td>
