    ...
    <div class="container">
        ...
        <table class="table table-borderless display responsive nowrap" style="width:100%">
            <tbody>
                ...
                $jumlah_query = mysqli_query($conn, "SELECT * FROM kegiatan_peserta WHERE id_kegiatan = " . $id);
        ...
        <form method="post">
            <div class="form-group">
                ...
                <table id="tabel-data" class="display responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        <?php $query = mysqli_query($conn, "SELECT * FROM kegiatan_peserta JOIN peserta ON kegiatan_peserta.id_peserta = peserta.id_peserta WHERE id_kegiatan = " . $id);
                        $cnt = 1;
